...
namespace order
{
    public class OrderService
    {
        ...
        public static bool QueryByCargoName(String cargoName)
        {
        ...
        public static bool SuperThanTotal(double total)
        {
            var quert = orderList
        ...
        public static bool LowerThanTotal(double total)
        {
            var quert = orderList
                .Where(order => order.TotalPrice <= total)
                .OrderBy(order => order.OrderNumber)
